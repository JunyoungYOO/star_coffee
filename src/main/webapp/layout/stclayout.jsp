...
<div class="w3-top">
  <div class="w3-row w3-padding w3-black">
    ...
    <div class="w3-col s2">
      <a href="order" class="w3-button w3-block w3-black">order</a>
    </div>
    <div class="w3-col s2">
      <a href="search" class="w3-button w3-block w3-black">search</a>
    </div>
    <div class="w3-col s2">
      <a href="board" class="w3-button w3-block w3-black">board</a>
    </div>
    <div class="w3-col s2">
      <a href="question" class="w3-button w3-block w3-black">question</a>
    </div>
  </div>
</div>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  ...
  <div class="w3-display-middle w3-center">
    <span class="w3-text-black" style="font-size:90px">Star<br>Coffee</span>
  </div>
